...
// in simulator we redefine to format for TiCustomView Developer console
...
{\
	NSString * exceptionName = [@"org.ticustomview." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ticustomview";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiCustomViewNativeItemNone = -1, 
	UITiCustomViewNativeItemSpinner = -2,
	UITiCustomViewNativeItemProgressBar = -3,
	
	UITiCustomViewNativeItemSlider = -4,
	UITiCustomViewNativeItemSwitch = -5,
	UITiCustomViewNativeItemMultiButton = -6,
	UITiCustomViewNativeItemSegmented = -7,
	
	UITiCustomViewNativeItemTextView = -8,
	UITiCustomViewNativeItemTextField = -9,
	UITiCustomViewNativeItemSearchBar = -10,
	
	UITiCustomViewNativeItemPicker = -11,
	UITiCustomViewNativeItemDatePicker = -12,
	
	UITiCustomViewNativeItemInfoLight = -13,
	UITiCustomViewNativeItemInfoDark = -14,
	
	UITiCustomViewNativeItemDisclosure = -15,
	
	UITiCustomViewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiCustomView instances of
