...
//Rare exceptions to indicate a bug in the _ticustomview code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TiCustomView proxies.
 */
