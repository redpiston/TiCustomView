...
/**
 Base class for all TiCustomView views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiCustomView view hierarchy (such as wrapped iOS UIViews) was touched.
