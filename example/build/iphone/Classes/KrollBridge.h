...
@interface TiCustomViewObject : KrollCoverageObject {
#else
@interface TiCustomViewObject : KrollObject {
#endif
@private
...
extern NSString * TiCustomView$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiCustomViewObject *_ticustomview;
    KrollObject* console;
	BOOL shutdown;
