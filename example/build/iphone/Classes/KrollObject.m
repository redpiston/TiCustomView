 ...
 * Copyright (c) 2009-2011 by TiCustomView, Inc. All Rights Reserved.
...
//@interface TiCustomViewObject : NSObject
//@end

@interface TiCustomViewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiCustomViewObject class]])
		{
			for (NSString *key in [[(TiCustomViewObject*)o modules] allKeys])
			{
